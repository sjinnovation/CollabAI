export const  FETCH_ALL_ASSISTANTS = (page, searchQuery=false) => `api/assistants/users?page=${searchQuery ? '1' : page}&pageSize=${searchQuery ? '20' : '6' }${searchQuery ? `&searchQuery=${searchQuery}` : ""}`;
