  ...
  const handleCreateAssistantChat = async (event) => {
    try {
      ...
      if (success) {
        ...
        setErrorMessage(message || "An unexpected error occurred. Please reload the page.");
      }
    } catch (error) {
      console.error("Error in handleCreateAssistantChat:", error);
      setErrorMessage("An error occurred while creating the response, please reload or try again.");
    } finally {
