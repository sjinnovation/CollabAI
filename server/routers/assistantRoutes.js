...
import {
  ...
  getFunctionCallingAssistantsCreatedByUser,
...
router
  ...
  .post(upload.array("files", 5), createAssistant);
...
router.post("/createassistant", upload.array("files", 5), createAssistant);
router.patch(
  "/updatedatawithfile/:assistant_id/",
...
router
  .route("/:assistant_id")
  .patch(authenticateUser, updateAssistant)
  .delete(authenticateUser, deleteAssistant);
///user/stats/
